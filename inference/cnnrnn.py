...
weight_file = "./downloads/airec/pretrained/CNNRNN/model.pth"
params_file = "./downloads/airec/pretrained/CNNRNN/args.json"
...
# load model
model = CNNRNN(rec_dim=params["rec_dim"], joint_dim=8, feat_dim=params["feat_dim"]).to(
    device
)
