...
class CNNRNNLN(nn.Module):
    """
    # CNNRNNLN
    This model has CNN encoder, RNN, and two decoders.
    CNNRNN model with LayerNorm.
    Input: image, joint, (state)
    Output: image, joint, state

    image: encoder_image -> lstm -> decoder_image
    joint: lstm -> decoder_joint
    """
